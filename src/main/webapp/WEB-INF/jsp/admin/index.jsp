<%@ page import="com.xxx.ssm.common.util.SessionKeysUtil" %>
<%@ page import="com.xxx.ssm.common.entities.AccountSession" %>
<%@ page import="com.xxx.ssm.common.entities.vo.AccountVO
" %><%--
...
<%
    ...
    String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
            + path + "/";
    AccountSession  accountSession = (AccountSession)request.getSession().getAttribute(SessionKeysUtil.PAMACCOUNT);
    AccountVO  accountVO=accountSession.getAccountData();
%>
<html>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="/resource/images/profile_small.jpg" /></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><%=accountVO.getLoginName()%></strong></span>
                                <span class="text-muted text-xs block">
                                    <%--<%=(StringUtil.isEmpty(msg) ? "" : msg) %>--%>
                                    <%=(accountVO.getAccountType().equals("admin")   ?  "管理员"  : "会员")  %>
                                    <b class="caret"></b>
                                </span>
                                </span>
                        </a>
                ...
                <!--后台用户管理-->
                <li>
                    <a class="J_menuItem" href="<%=basePath%>admin/pamAccount/index.html"><i class="fa fa-columns"></i> <span class="nav-label">后台用户管理</span></a>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/resource/images/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/resource/images/a4.jpg">
                                    </a>
                                    <div class="media-body ">
        ...
        <div class="row content-tabs">
            ...
            <a href="<%=basePath%>admin/logout.html" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            ...
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=basePath%>/admin/bookmark.html" frameborder="0" data-id="index_v1.html" seamless></iframe>
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/resource/images/a7.jpg">
                                </div>
                                <div class="media-body">
